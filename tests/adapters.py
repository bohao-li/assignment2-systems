...
def get_flashattention_autograd_function_pytorch() -> Type:
    ...
    from cs336_systems.flash_attention import FlashAttentionForwardPass

    return FlashAttentionForwardPass
...
def get_ddp_individual_parameters(module: torch.nn.Module) -> torch.nn.Module:
    ...
    """
    from cs336_basics.ddp_container import DDPContainerAsync
    return DDPContainerAsync(module)
